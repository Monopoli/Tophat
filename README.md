...
- **Cheats tab** — misc object manipulation for any tracked biped/vehicle: teleport to manual X/Y/Z coordinates or to another live object's position, speed boost (forward-facing direction or a raw velocity vector) with a one-click stop, and Vitality controls (manual HP/shield entry, Full Health/Shields, Kill)
...
| `ui_cheats.py` | Cheats tab (teleport, speed, vitality) |
