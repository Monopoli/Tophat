...
# ── s_object_data field offsets ────────────────────────────────────────────
# Shared by parser.py (reads) and ui_cheats.py (writes) so the two paths
# can't drift apart. Values match parser.py's original hardcoded literals.
OBJ_ORIGIN_OFF    = 0x64   # 3x f32 (x, y, z)
OBJ_TRANS_VEL_OFF = 0x88   # 3x f32 (vx, vy, vz)
OBJ_HEALTH_OFF    = 0xEC   # f32
OBJ_SHIELDS_OFF   = 0xF0   # f32
